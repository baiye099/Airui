...
description: "Provides complete file upload and download functionality, supporting multiple file types with validation. Invoke when creating Spring Boot applications that need file handling capabilities."
---
