...
public class DBUtil {
    ...
    //数据库配置文件路径
    private static final String CONFIG_FILE_PATH = "config/db.properties";
    ...
    static {
        try {
            ...
            InputStream is = DBUtil.class.getClassLoader().getResourceAsStream(CONFIG_FILE_PATH);
            if (is == null) {
            ...
            driver = props.getProperty("db.driver");//将配置文件中的db.driver配置项的值读取到driver变量中
